...
//   const fallbackTexture00 = useTexture("/textures/sphericalTrochoids.png");
//   const fallbackTexture01 = useTexture("/textures/slimeClock.png");
//   const fallbackTexture02 = useTexture("/textures/symphonyOfLife.png");
//   const fallbackTexture03 = useTexture("/textures/r3fExperiments.png");
//   const fallbackTexture04 = useTexture("/textures/clockEnvy.png");
  ...
  return (
    <group ref={groupRef} name="projects-display-group">
      {states.showDisplays && (
        ...
        //     <VideoMaterial src={states.videoTextureSource} />
        //   </Suspense> */}
        <Html occlude="blending" transform style={{ height: 192, width: 108 }}>
          <video width={108} height={192} autoPlay loop muted playsInline>
            <source src={states.videoTextureSource} type="video/mp4" />
            {"Your browser does not support the video tag. :("}
            {
              "If you're seeing this message, it means the video textures aren't working for some reason. You can check out the projects by clicking on the display, or by clicking on the links below! Sorry for the inconvenience! :("
            }
          </video>
        </Html>
        //   </mesh>
