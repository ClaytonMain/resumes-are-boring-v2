...
export default function EnterHtml() {
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
    >
      <motion.div className="flex h-10/12 w-full flex-col rounded-xl border px-12 py-12 sm:w-5/12">
        <motion.h1
        ...
        <motion.div className="mt-auto flex justify-end text-2xl tracking-tighter italic">
